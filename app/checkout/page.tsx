...
const CheckoutPage = () => {
  ...
  // Mock order items (would typically be fetched from cart state or API)
  ...
  // State for shipping and billing information
  ...
  // State for billing/payment options
  ...
  const handleShippingInfoChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // If billing is same as shipping, update billing info as well
    if (sameAsShipping) {
      setBillingInfo(prev => ({
        ...prev,
        [name]: value
  ...
  const handleSameAsShippingChange = () => {
    ...
    // If checked, copy shipping info to billing info
    if (newValue) {
  ...
  const handleCheckout = () => {
    // Here you would typically validate inputs and submit order to your backend
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <label htmlFor="paypal" className="ml-3 flex items-center">
                          <span className="text-gray-700 mr-2">PayPal</span>
                      ...
                      <div className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <label htmlFor="creditCard" className="ml-3 flex items-center">
                          <span className="text-gray-700 mr-2">Credit Card</span>
