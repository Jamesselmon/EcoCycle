    ...
    if (orderId) {
      ...
      setTimeout(() => {
        ...
        setOrderDetails({
          ...
          status: 'shipped',
          items: [
            { id: '1', name: 'Eco-Friendly Water Bottle', quantity: 2, price: 15.99, imageUrl: 'https://via.placeholder.com/100x100' },
            { id: '2', name: 'Bamboo Utensil Set', quantity: 1, price: 12.50, imageUrl: 'https://via.placeholder.com/100x100' }
          ],
          shipping: {
            name: 'John Doe',
            address: '123 Main St',
