                ...
                {activeTab === 'addresses' && (
                  <div className="bg-white shadow rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      ...
                      {/* Option to add additional address when one already exists */}
                      {userProfile?.defaultShippingAddress && !editingAddress && !addingAddress && (
                        <div className="mt-6">
                          <button
                            className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-emerald-600 bg-emerald-100 hover:bg-emerald-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
                            onClick={startAddingAddress}
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
